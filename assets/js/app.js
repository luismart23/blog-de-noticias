...
function mostrarCategoria(categoria) {
    ...
    noticias.forEach(noticia => {
        if (noticia.categoria['nombre-categoria'] === categoria) {
...
$(document).ready(function () {
    ...
    // __________________________________primera_forma________-
    // noticias.forEach((noticia) => {
    //     console.log(noticia)
    //     // append concatenar
    //     // console.log(noticia.tags.join(" #"))
    //     // 4. pintar elemento en el Dom
    //     noticiasDOM.append(`

    //   <article class="col-12 col-md-6 mb-3">
    //             <div class="card h-100">
    //                 <img src="${noticia["imagen-url"]}" alt="" class="card-img-top">
    //                 <div class="card-body">
    //                     <h5>${noticia.titulo}</h5>
    //                     <p class="small">
    //                         <span>Categorias:</span>
    //                         <span class="badge text-bg-primary">${noticia.categoria["nombre-categoria"]}</span>
    //                     </p>
    //                     <p>${noticia.descripcion}</p>
    //                     <p>Tags: #${noticia.tags.join(" #")}</p>
    //                 </div>
    //             </div>
    //         </article>
    //     `)
    ...
    // _______________FORMA_MAS-EFICIENTE_______________________----
    $(document).ready(function () {
        const noticiasDOM = $("#noticiasDOM");
